...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=LAPTOP-QV2G33GM\\SQLEXPRESS;Database=WebsiteBanHang;Trusted_Connection=True;TrustServerCertificate= true;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Blog>(entity =>
        {
            entity.HasKey(e => e.IdBlog).HasName("PK__BLOG__75519326A4ACE779");
        ...
        {
            entity.HasKey(e => e.IdCart).HasName("PK__CART__7A1680A5B815251F");
        ...
        {
            entity.HasKey(e => e.IdCd).HasName("PK__CART_DET__8B622F8F76D86052");
        ...
        {
            entity.HasKey(e => e.IdCat).HasName("PK__CATOLOGY__2BF8FA1C11189CBF");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__MENU__4728FC6052D3A8CD");
        ...
        {
            entity.HasKey(e => e.IdPro).HasName("PK__PRODUCTS__20AF98FD5A11D66A");
        ...
        {
            entity.HasKey(e => e.IdSlide).HasName("PK__SLIDER__22D1BB107D0BB028");
        ...
        {
            entity.HasKey(e => e.IdUsers).HasName("PK__USERS__1DDB35C3C9EE69AB");
